//Matteo created openingBarChart to show the opening price compared to the total time of the stock
//Matte updated the class to display 5 year, 2 year, 1 year and will diplay no data if there is no data to display
//Ruxin, fixed a bug that the silder of opening bar chart doesn't work,10am, 22/04
