...
Widget searchButton, upArrowWidget, downArrowWidget, slideWidget,
       ...
       selectChart2,  backButton, forwardButton, dateRange;
Widget[] searchList;
...
final int EVENT_UP_ARROW = 1;
final int EVENT_DOWN_ARROW = 2;
...
final int SEARCH_SPECIFIC_YEAR = 7, SEARCH_SPECIFIC_MON = 8, SEARCH_SPECIFIC_DAY = 9;
final int SEARCH_SPECIFIC_YEAR_1 = 11, SEARCH_SPECIFIC_MON_1 = 12, SEARCH_SPECIFIC_DAY_1 = 13;
final int EVENT_SLIDEWIDGET = 10;
final int EVENT_DATASLIDEWIDGET = 28;
...
final int BARCHART = 15;
final int POINTSCHART = 16;
...
final int BACK_BUTTON = 26;
final int FORWARD_BUTTON = 27;
final int DATE_RANGE = 29;

//Screen screen1, currentScreen;
int focus = EVENT_NULL;
int searchListNo = 0;
double LargestChange = 0;
String LchangeDate = ""; //the date with the largest change
String year = "yyyy", month = "mm", day = "dd", 
...
void setup() {
  ...
  // Yifan Zhu, Added two arrows back because 
  // we need them for scrolling the list, 11pm, 22/3/2020
  upArrow = loadImage("upArrow.png");
  downArrow = loadImage("downArrow.png");
  upArrowWidget = new Widget(120, 95, 50, 50, EVENT_UP_ARROW, 0, 0, 0, 0);
  upArrowWidget.setImage(upArrow);
  downArrowWidget = new Widget(120, 807, 50, 50, EVENT_DOWN_ARROW, 0, 0, 0, 0);
  downArrowWidget.setImage(downArrow);
  
  leftArrow = loadImage("backwardsArrow.png");
  rightArrow = loadImage("forwardsArrow.png");
  backButton = new Widget(360, 540, 50, 50, BACK_BUTTON, 0, 0, 0, 0);
  backButton.setImage(leftArrow);
  forwardButton = new Widget(880, 540, 50, 50, FORWARD_BUTTON, 0, 0, 0, 0);
  forwardButton.setImage(rightArrow);
  
  
  // Yifan Zhu, Added the slideWidget as the background for the slider,
  // 12am, 29/3/2020
  slideWidget = new Widget(125, 138, 38, 675, EVENT_SLIDEWIDGET, 0, 0, 0, 0);
  slideWidget.setWidgetColor(200);
  slideWidget.setLabelColor(0);
  slideWidget.setLabel("");

  dataSlideWidget = new Widget(450, 565, 400, 20, EVENT_DATASLIDEWIDGET, 0, 0, 5, 5);
  dataSlideWidget.setWidgetColor(200);
  dataSlideWidget.setLabelColor(0);
  dataSlideWidget.setLabel("");

  // Yifan Zhu, Added the searchWidget object for searching
  // for a designated stock, 4pm, 17/3/2020
  searchWidget = new TextWidget(25, 25, 120, 50, currentLabel, stdFont, SEARCH_WIDGET, 5, 10, 10, 10, 10);
  searchWidget.setLabelColor(200);
  // Yifan Zhu, Added the searchButton object for
  // the search button, 11pm, 17/3/2020
  ...
  //Ruxin, edit parameters for widgets and make the new menu, add prompt for users,2pm,21/04
  int y = 100;
  
  //Ruxin, added searchSpecificYear & searchButton2 for searching specific conditions, 25/03, 8pm
  //Tim, edditted parameters for searchButton and searchButton2 for rounded corners 07/04/2020
  searchSpecificYear = new TextWidget(180, y+365, 55, 25, year, stdFont, SEARCH_SPECIFIC_YEAR, 4, 0, 0, 0, 0);
  searchSpecificYear.setLabelColor(200);
  searchSpecificMon = new TextWidget(235, y+365, 35, 25, month, stdFont, SEARCH_SPECIFIC_MON, 2, 0, 0, 0, 0);
  searchSpecificMon.setLabelColor(200);
  searchSpecificDay = new TextWidget(270, y+365, 30, 25, day, stdFont, SEARCH_SPECIFIC_DAY, 2, 0, 0, 0, 0);
  searchSpecificDay.setLabelColor(200);
  
  //Ruxin, added widgets for searhing in the date range, 01/04, 9pm
  searchSpecificYear_1 = new TextWidget(180, y+390, 55, 25, year1, stdFont, SEARCH_SPECIFIC_YEAR_1, 4, 0, 0, 0, 10);
  searchSpecificYear_1.setLabelColor(200);
  searchSpecificMon_1 = new TextWidget(235, y+390, 35, 25, month1, stdFont, SEARCH_SPECIFIC_MON_1, 2, 0, 0, 0, 0);
  searchSpecificMon_1.setLabelColor(200);
  searchSpecificDay_1 = new TextWidget(270, y+390, 30, 25, day1, stdFont, SEARCH_SPECIFIC_DAY_1, 2, 0, 0, 10, 0);
  searchSpecificDay_1.setLabelColor(200);  
  //Ruxin, deleted searchButton2 and integrated all search buttons to one,9pm, 15/04
  //searchButton2 = new Widget(765, 25, 100, 50, SEARCH_BUTTON_DATE, 10, 10, 10, 10);
  //searchButton2.setWidgetColor(color(200, 20, 200));
  //searchButton2.setLabelColor(color(255));
  //searchButton2.setLabel("Search");
  
  //Ruxin, deleted selectChartButton and integrated all search buttons to one,9pm, 15/04
  //Matteo added selectChart Button 02/04/20
  //selectChartButton = new Widget(300, 25, 150, 50, CHOOSE_CHART, 10, 10, 10, 10);
  //selectChartButton.setWidgetColor(color(200, 20, 200));
  //selectChartButton.setLabelColor(color(255));
  //selectChartButton.setLabel("Choose Chart");

    barChart = new Widget(180, y+25, 120, 25, BARCHART, 10, 10, 0, 0);
    barChart.setWidgetColor(color(200, 20, 200));
    barChart.setLabelColor(color(255));
    barChart.setLabel("Bar Chart");
    
    pointsChart = new Widget(180, y+50, 120, 25, POINTSCHART, 0, 0, 10, 10);
